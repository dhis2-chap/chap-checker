"""Check that chap-core is actually running behind the DHIS2 ``chap`` route."""
...
@register_check
class Dhis2ChapCoreCheck:
    """Hit chap-core through the route and confirm it's actually running."""

    name: ClassVar[str] = "dhis2_chap_core"
    description: ClassVar[str] = "chap-core reachable via /api/routes/chap/run/system/info and reports a version."
